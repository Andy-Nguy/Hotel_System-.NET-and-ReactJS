...
const AmenticsManager: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'amenities' | 'rooms'>('amenities');
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 16 }}>
              <button
                ...
                style={{
                  padding: '8px 14px',
                  borderRadius: 10,
                  border: activeTab === 'amenities' ? 'none' : '1px solid #e5e7eb',
                  background: activeTab === 'amenities' ? 'linear-gradient(135deg,#059669,#10b981)' : '#fff',
              ...
              <button
                ...
                style={{
                  ...
                  background: activeTab === 'rooms' ? 'linear-gradient(135deg,#059669,#10b981)' : '#fff',

          ...
          <Tabs
            ...
            items={[
              ...
              },
              {
                ...
                children: (
                  <Card>
                    <Descriptions title="Hệ thống cấp bậc" bordered style={{ marginBottom: 16 }}>
                      <Descriptions.Item label="Quy tắc">
                        Khách hàng tự động được xếp hạng dựa trên tổng điểm tích lũy. Mỗi 10,000 VND chi tiêu = 1 điểm.
                      </Descriptions.Item>
                    </Descriptions>

...
public class BookingController : ControllerBase
{
    ...
    public async Task<IActionResult> RescheduleBooking(string bookingId, [FromBody] RescheduleRequest request)
    {
        using var transaction = await _context.Database.BeginTransactionAsync();
        try
        {
            ...
            _logger.LogInformation("Booking {BookingId} rescheduled successfully", bookingId);
...
";
            ...
            // ✅ GỬI EMAIL THẬT
            await _emailService.SendEmailAsync(email, hoTen, emailSubject, emailBody);
